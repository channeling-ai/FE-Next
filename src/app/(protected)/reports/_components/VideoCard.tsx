...
export default function VideoCard({
    ...
    return (
        <div className="flex flex-col max-w-82 border border-transparent hover:border-border-active rounded-[20px]">
            ...
            <div className="flex flex-col p-4 w-full  items-start self-stretch bg-bg-1 rounded-b-[20px]">
                ...
                <div className="flex items-start gap-[8.816px] self-stretch">
                    ...
                    {leftsideamount && <div className="text-text-secondary font-body-14r pl-1">{leftsideamount}</div>}
                    <div className="text-gray-600 font-body-14r">·</div>
                    <div className="text-text-secondary font-body-14r">{rightside}</div>
                    {rightsideamount && <div className="text-text-secondary font-body-14r pl-1">{rightsideamount}</div>}
                </div>
            </div>
        </div>
    )
