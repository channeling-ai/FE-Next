...
export default function SavedIdeaCard({ onClick }: SaveCardProps) {
    ...
    return (
        ...
        >
            ...
            <h3 className="flex-1 line-clamp-1 font-body-16b text-test-primary">코케트(coquette) 패션 인사</h3>
            <p className="min-h-[calc(1em*1.5*2)] line-clamp-2 font-body-18r text-gray-600">
            ...
            <div className="flex flex-row flex-wrap gap-2">
                <p className="px-2 py-1 rounded-[10px] bg-text-brand/8 text-text-brand font-body-16m">#ddd</p>
            </div>
        </div>
    )
}
