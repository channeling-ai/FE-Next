    ...
    return (
        <article className="flex w-full flex-col gap-4">
            <header className="flex flex-col gap-2">
                <h2 className="font-title-18sb text-text-primary desktop:text-[20px]">{insight.title}</h2>
            ...
            <div className="space-y-[21px] font-body-14r text-text-secondary desktop:space-y-6 desktop:text-[16px] desktop:leading-[1.5]">
                <p>{insight.detailIntro}</p>
                <p>{insight.detail}</p>
            </div>

            <section className="font-body-14r text-text-secondary desktop:text-[16px] desktop:leading-[1.5]">
